...
export const RECEIVE_QUESTION_AND_ANSWERS = 'RECEIVE_QUESTION_AND_ANSWERS';
...
export const receiveQuestionAndAnswers = (payload) => {
    return {
        type: RECEIVE_QUESTION_AND_ANSWERS,
        payload
    }
}
...
export const requestQuestion = questionId => dispatch => (
    ...
    .then(payload => dispatch(receiveQuestionAndAnswers(payload)))
    .fail(errors => dispatch(receiveQuestionErrors(errors.responseJSON)))
)
